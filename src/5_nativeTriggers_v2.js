...
(function (nativeNameSpace) {
  ...
  const nativeRemoveEventListener = nativeNameSpace.EventTarget.prototype.removeEventListener;
  const nativeStopImmediatePropagation = nativeNameSpace.Event.prototype.stopImmediatePropagation;
